...
public class MultiDimensionalArrayPractice {
    public static void main(String[] args) {
        ...
        for (int i = arr2D.length - 1; i >= 0; i--) {//i: index number of
            // each single dimensional array, i starts counting back wards

            for (int j = 0; j < arr2D[i].length; j++) {//j: index number of
                // each elements in the index of each single dim array
...
/*
arr2D.length-1: used to count backwards
 */