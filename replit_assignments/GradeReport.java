...
public class GradeReport {
    public static void main(String[] args) {
        ...
        System.out.println("Summary: "+sub1+" -"+grade1+", "+sub2+" -"+grade2+", "+sub3+" -"+grade3+", "+
                sub4+" -"+grade4+", "+sub5+" -"+grade5);
        System.out.println("Your average score is: "+avgGrade);
...
/*
Write the program that will calculate the average grade. Use 5 String variables and 6 double variables to hold the
subject and the grade value. Build a summary with all the information by concatenating the subjects and grades.
 Then calculate the average grade and print display the average score too.

Execution flow with exam ple:
